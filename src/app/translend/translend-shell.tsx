...
const collectionByModule: Partial<Record<ModuleKey, BusinessCollection>> = { Deliveries: 'deliveries', POD: 'pods', Exceptions: 'exceptions', Routes: 'routes', Maintenance: 'maintenance', Inspections: 'inspections', Compliance: 'compliance', Tyres: 'tyres', Fuel: 'fuel', Expenses: 'expenses', Invoices: 'invoices', Receipts: 'receipts', Statements: 'statements', 'Rate Cards': 'rateCards' }
