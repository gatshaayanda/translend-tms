...
function age(date: Timestamp | null) { if (!date) return "—"; const days = Math.ceil((Date.now() - date.toMillis()) / 86400000); return days <= 0 ? "Current" : `${days}d`; }
